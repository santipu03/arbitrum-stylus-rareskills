...
1. `/* 1. ______ */`
    ...
    Hint: Replace with the borrow attribute.

2. `/* 2. ______ */`

    Hint: Inherit from the contracts in the order, `contract_b` first, then `contract_a`, using the `inherit` attribute.

3. `/* 3. ______ */`

    Hint: Within the `foofoo` function, call the `ret_num()` function defined in `contract_a`, and return its value.
